    ...
    public class EyeGazeAnalysisModulePresenter : MonoBehaviour
    {
        ...
        private void OnClickGenerate()
        {
            ...
            var generationParameters = new EyeGazeAnalysisModuleParameters
            {
                ...
                ReceiversIdentifiers = ui.ProjectionReceiversIdsTextField.value.Trim().Split(",").Where(s => s.Length > 0).ToArray(),
            ...
            _generationCoroutine = StartCoroutine(module.GenerateHeatmap(player.GetRecordLoader(), player.GetPlayerAssets(), generationParameters, onFinishCallback));
        }
