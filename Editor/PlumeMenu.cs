...
namespace PLUME.Editor
{
    public static class PlumeMenu
    {
        ...
        private const string PrefabManagerPath =
            "Packages/fr.liris.plume.viewer/ScriptableObjects/EditorExtensions/PlumePrefabManager.asset";
        ...
        [MenuItem("GameObject/PLUME/Player", priority = MenuPriority)]
        private static void CreatePlayer()
        {
            SafeInstantiate(prefabManager => prefabManager.playerPrefab);
        }
    }
}